...
func (rtu *RefreshTokenUpdate) SetUID(u uuid.UUID) *RefreshTokenUpdate {
	rtu.mutation.SetUID(u)
	return rtu
}
...
// SetUID sets the "uid" field.
func (rtuo *RefreshTokenUpdateOne) SetUID(u uuid.UUID) *RefreshTokenUpdateOne {
	rtuo.mutation.SetUID(u)
	return rtuo
}
