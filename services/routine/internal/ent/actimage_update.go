...
func (aiu *ActImageUpdate) SetSrc(s string) *ActImageUpdate {
	aiu.mutation.SetSrc(s)
	return aiu
}

// SetActVersionID sets the "act_version" edge to the ActVersion entity by ID.
func (aiu *ActImageUpdate) SetActVersionID(id uint64) *ActImageUpdate {
	aiu.mutation.SetActVersionID(id)
	return aiu
}
...
func (aiu *ActImageUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := aiu.mutation.Src(); ok {
...
// SetSrc sets the "src" field.
func (aiuo *ActImageUpdateOne) SetSrc(s string) *ActImageUpdateOne {
	aiuo.mutation.SetSrc(s)
	return aiuo
}

// SetActVersionID sets the "act_version" edge to the ActVersion entity by ID.
func (aiuo *ActImageUpdateOne) SetActVersionID(id uint64) *ActImageUpdateOne {
	aiuo.mutation.SetActVersionID(id)
	return aiuo
}
...
func (aiuo *ActImageUpdateOne) sqlSave(ctx context.Context) (_node *ActImage, err error) {
	...
	if value, ok := aiuo.mutation.Src(); ok {
		_spec.SetField(actimage.FieldSrc, field.TypeString, value)
	}
