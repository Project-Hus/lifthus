...
// SetLifthusCorsHeaders sets headers for CORS.
func SetLifthusCorsHeaders(next echo.HandlerFunc) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		c.Response().Header().Set("Access-Control-Allow-Origin", os.Getenv("LIFTHUS_ORIGINS"))
